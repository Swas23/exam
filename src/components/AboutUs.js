      ...
      <>
        <div className="container">
          <img
            ...
            alt="..."
          ></img>
          <h1 style={{fontFamily:"cursive",color:"Grey",textAlign:"center"}}>About Us</h1>
          <div id="accordion">
            <div className="card">
              <div
            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <li>E-Mail:Travas.india@gmail.com</li>
              </div>
            </div>
          </div>
        </div>
        <footer class="bg-light pb-5">
          <div class="container text-center">
            <div>
              ...
              <div>E-Mail:Travas.india@gmail.com</div>
            </div>
            <p class="font-italic text-muted mb-0">
              &copy; Copyrights Travas India.com All rights reserved.
            </p>
          </div>
        </footer>
      </>
